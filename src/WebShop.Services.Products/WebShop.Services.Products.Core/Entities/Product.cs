...
namespace WebShop.Services.Products.Core.Entities
{
    public class Product : BaseEntity
    {
        ...
        public void SetName(string name)
        {
            ...
            {
                throw new DomainException("empty_product_name",
        ...
        public void SetVendor(string vendor)
        {
            ...
            {
                throw new DomainException("empty_product_vendor",
        ...
        public void SetDescription(string description)
        {
            ...
            {
                throw new DomainException("empty_product_description",
        ...
        public void SetPrice(decimal price)
        {
            if (price <= 0)
            {
                throw new DomainException("invalid_product_price",
